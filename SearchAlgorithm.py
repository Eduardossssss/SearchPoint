...
if __name__ == '__main__':
    while True:
        try:
            w = int(input('Введите ширину координатной плоскости: '))           # проверяем правильность ввода ширины координатной плоскости
            if w < 0:
        ...
        while True:
            try:
                h = int(input('Введите высоту координатной плоскости: '))       # проверяем правильность ввода высоты координатной плоскости
                if h < 0:
        ...
        while True:
            try:
                x = int(input('Введите координату x для стартовой точки: '))    # проверяем правильность ввода координаты x стартовой точки
                if not 0 <= x <= w:
            ...
            while True:
                try:
                    y = int(input('Введите координату y для стартовой точки: ')) # проверяем правильность ввода координаты y стартовой точки
                    if not 0 <= y <= h:
